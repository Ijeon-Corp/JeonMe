...
- **Production**: https://jeonme.com — rilis pertama `v0.1.0` (domain yang benar-benar melayani traffic saat ini; migrasi ke `jeon.id` disiapkan sejak 18 Agustus 2026 di sisi kode, tapi eksekusi infra -- DNS/vhost Apache/TLS -- belum jalan, lihat `SETUP-GUIDE.md` §1.1)
