    ...
    <main className="mx-auto flex min-h-screen max-w-md flex-col items-center bg-jeon-purple/10/30 px-5 py-10">
      <div className="w-full rounded-2xl border border-border bg-white p-6 text-center shadow-card">
        {card.avatar_url ? (
          ...
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-jeon-purple/10 text-2xl font-bold text-jeon-purple">
            {card.full_name.charAt(0).toUpperCase() || "?"}
          </div>
        )}

        <h1 className="mt-3 font-heading text-xl font-bold text-app-ink">{card.full_name}</h1>
        ...
        <div className="mt-4 flex flex-col gap-2 text-left">
          {card.phone && (
            <div className="flex items-center gap-2 rounded-lg border border-border px-3 py-2 text-sm text-app-ink">
          ...
          {card.website && (
            <a
              ...
              className="flex items-center gap-2 rounded-lg border border-border px-3 py-2 text-sm text-app-ink hover:border-jeon-purple hover:text-jeon-purple"
            >
