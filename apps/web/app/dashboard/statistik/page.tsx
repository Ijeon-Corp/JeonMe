...
// Modul Statistik (JEONID-DASHBOARD-REDESIGN-SPEC.md §16, Phase 3): tab
// Overview BARU (KPI views/klik/CTR/pendapatan + tren + top konten +
// sumber trafik + perangkat -- panel Referral & Perangkat PINDAHAN dari
// Beranda §9.3), rentang kustom + Export CSV di toolbar (standarisasi
// RangeControl), pembanding periode ekuivalen sebelumnya (§16.5). Data
// tetap AnalyticsHandler yang sama; nol logika backend baru. LENGKAP &
// stabil di production sejak v0.37.0/v0.38.0, flag "home" dihapus dari
// file ini 8 September 2026 (LegacyStatistikPage ikut dihapus).
