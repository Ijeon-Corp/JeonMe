...
// (JEONID-DASHBOARD-REDESIGN-SPEC.md §20.1, Phase 7). Satu file, NOL edit
// per-halaman: subpage settings otomatis dapat rail navigasi kiri di
// desktop (lg+; di bawahnya subnav jadi baris pill horizontal scroll).
// DIKECUALIKAN: hub /settings (punya grid kartunya sendiri) dan
// /settings/seo (milik domain Halaman Saya -- pakai HalamanSayaTabs, bukan
// subnav Pengaturan; tetap terdaftar di subnav sebagai tautan keluar
// sesuai §20.1). KYC & Rekening juga terjangkau dari grup Keuangan
// sidebar; subnav ini melengkapi, bukan menggantikan. LENGKAP & stabil di
// production sejak v0.37.0/v0.38.0, flag "settings" dihapus dari file ini
// 8 September 2026.
...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  if (pathname === "/dashboard/settings" || pathname === "/dashboard/settings/seo") {
    return <>{children}</>;
  }
