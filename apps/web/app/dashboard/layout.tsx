...
export default function DashboardLayout({
  ...
  const { t } = useLocale();
  // Shell v2 (JEONID-DASHBOARD-REDESIGN-SPEC §5-6, Phase 2). LENGKAP &
  // stabil di production sejak v0.37.0/v0.38.0, flag "shell" dihapus dari
  // file ini 8 September 2026. buildNavItems/currentPageLabel TETAP
  // dipakai -- BUKAN sisa legacy, tapi fallback judul topbar untuk rute
  // yang belum masuk DASHBOARD_PAGE_REGISTRY (mis. /dashboard/links/
  // builder/[pageId]), lihat pemakaian di bawah.
  ...
  const [expandedGroups, setExpandedGroups] = useState<Set<string>>(() => {
    ...
    // Cocokkan pathname ke leaf grup IA baru (label grup beda dari nav
        ...
        <div className="app-shell flex min-h-screen">
          ...
          <div className="flex min-w-0 flex-1 flex-col">
            ...
            <header className="nav-glass sticky top-0 z-20 hidden h-[72px] items-center justify-between gap-3 px-6 md:flex">
              ...
              {/* Judul dari page-registry (§6.6) + breadcrumb induk pada
                  kedalaman >1 (§6.5); fallback ke resolusi label legacy
                  untuk rute yang belum masuk registry. */}
              ...
              <div className="flex flex-shrink-0 items-center gap-1.5">
                ...
                {isPublished !== null && pageMeta?.domain === "page" && (
                  <span
