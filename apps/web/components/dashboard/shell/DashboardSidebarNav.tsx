...
export function buildRailItemsV2(t: (key: string) => string): { href: string; label: string; icon: IconComponent; matchPrefixes: string[] }[] {
  return [
    ...
    { href: "/dashboard/products?tab=overview", label: t("dashboard.nav.sales"), icon: IconShoppingBag, matchPrefixes: ["/dashboard/products", "/dashboard/courses", "/dashboard/bookings", "/dashboard/events", "/dashboard/donation"] },
    { href: "/dashboard/audience?view=contacts", label: t("dashboard.nav.marketing"), icon: IconStar, matchPrefixes: ["/dashboard/audience", "/dashboard/business-card", "/dashboard/vouchers", "/dashboard/bundles", "/dashboard/affiliates", "/dashboard/loyalty", "/dashboard/social-proof"] },
