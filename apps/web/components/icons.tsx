...
// IconGithub -- permintaan langsung pengguna, 24 Agustus 2026 (template
// "Dimas Dev" bertema developer): platform sosial baru, lihat catatan
// lengkap di migrasi 000078 & lib/social-links.ts. Path SAMA sumber & pola
// dengan ikon Simple Icons lain di file ini (lihat catatan di atas).
...
// IconTextLines -- dipakai chrome UI dashboard (mis. tombol "Custom
// Message" produk, ManageProductModal.tsx). Diperbarui 17 September 2026:
// 3 garis SAMA PANJANG sebelumnya gampang terbaca sebagai ikon "menu"
// (hamburger); sekarang panjangnya bervariasi supaya jelas terbaca
// sebagai potongan paragraf. CATATAN: ikon block_type "text"/"heading" di
// CONTENT_TILES/BLOCK_TYPE_ICON (dashboard/links, ProdukPageEditor,
// BuilderAddComponentModal, BuilderLeftPanel) SEKARANG pakai lucide-react
// `Type` langsung, BUKAN komponen ini lagi -- lihat lib/icon-library.ts
// (komentar arsitektur: icons.tsx khusus chrome UI dashboard sendiri,
// ~44 ikon, bukan galeri representasi tipe konten ke pengguna; kebutuhan
// "ikon tipe konten yang lebih matang dari library siap pakai" SEHARUSNYA
// lucide-react, pola yang sama seperti PagePreview.tsx (HelpCircle utk
// FAQ, dst) & icon-library.ts).
