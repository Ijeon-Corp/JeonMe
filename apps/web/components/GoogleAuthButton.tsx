...
export default function GoogleAuthButton({
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="flex w-full items-center justify-center gap-2.5 rounded-jmd border-2 border-app-border bg-app-surface px-5 py-3.5 text-sm font-bold text-app-ink transition-colors hover:border-jeon-purple"
    >
      <GoogleGIcon />
      {label}
    </button>
