...
export const PAGE_THEMES: Record<Exclude<PageThemeName, "custom">, PageTheme> = {
  ...
  rose: {
    ...
    buyButton: "bg-rose-600 text-white font-bold hover:brightness-105",
  ...
  peach: {
    ...
    buyButton: "bg-orange-400 text-ink font-bold hover:brightness-105",
  ...
  // Kartu "kaca gelap" (bg-black/35 + backdrop-blur-md, SEBELUMNYA
  // bg-white/10 "kaca susu") + drop-shadow di nama/bio -- audit visual
  // template 25 September 2026 (permintaan langsung pengguna "make the
  // glass themes safe on bright backgrounds"): overlay yang dibakar ke
  // foto cuma menggelapkan bagian ATAS, kartu di tengah/bawah foto terang
  // (pantai/gurun/kafe/kota, juga video surge/atmos/ember) turun ke
  // ~2.5:1. Berlaku utk SEMUA tema foto & video berkartu kaca, bukan cuma
  // yg gagal, karena kreator bisa menaruh blok di posisi mana pun.
  dusk: {
    label: "Dusk",
    ...
    card: "border border-white/15 bg-black/35 backdrop-blur-md hover:bg-black/45 hover:-translate-y-0.5",
    cardTitle: "text-white",
    chevron: "text-white/60",
    productCard: "border border-white/15 bg-black/35 backdrop-blur-md",
    productTitle: "text-white",
  ...
  brew: {
    label: "Brew",
    // Lapisan gelap 30% di atas foto (audit 25 September 2026): rolling
    // door terang di bagian atas cafe.jpg membuat nama/bio putih cuma
    // ~3.5:1 -- overlay bawaan foto tidak cukup utk tema ini saja.
    page: "bg-[linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('/wallpapers/cafe.jpg')] bg-cover bg-center bg-no-repeat",
    glow: "hidden",
    avatarRing: "ring-4 ring-white/80 shadow-hero",
    name: "text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.45)]",
    bio: "text-white/90 drop-shadow-[0_1px_6px_rgba(0,0,0,0.4)]",
    ...
    footer: "text-white/40 hover:text-white",
    swatch: "#8B5E34",
    previewBg: "linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)), url('/wallpapers/cafe.jpg') center/cover",
    previewIsDark: true,
  ...
  lagoon: {
    ...
    name: "text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.45)]",
    bio: "text-white/90 drop-shadow-[0_1px_6px_rgba(0,0,0,0.4)]",
    card: "border border-white/15 bg-black/45 backdrop-blur-md hover:bg-black/55 hover:-translate-y-0.5",
    cardTitle: "text-white",
    chevron: "text-white/60",
    productCard: "border border-white/15 bg-black/45 backdrop-blur-md",
    productTitle: "text-white",
    productPrice: "text-white/90",
    buyButton: "bg-white text-ink font-bold hover:brightness-95",
    footer: "text-white/40 hover:text-white",
  ...
  candy: {
    ...
    buyButton: "bg-fuchsia-600 text-white font-bold hover:brightness-105",
  ...
  vapor: {
    ...
    label: "Vapor",
    page: "bg-gradient-to-br from-fuchsia-600 via-purple-600 to-cyan-600",
    glow: "bg-gradient-to-br from-cyan-300/25 via-fuchsia-300/15 to-transparent",
    avatarRing: "ring-4 ring-white/80 shadow-hero",
    name: "text-white",
    bio: "text-white/85",
    card: "border border-white/20 bg-black/15 backdrop-blur-md hover:bg-black/25 hover:-translate-y-0.5",
    cardTitle: "text-white",
    chevron: "text-white/55",
    productCard: "border border-white/20 bg-black/15 backdrop-blur-md",
    productTitle: "text-white",
  ...
  azure: {
    ...
    // Audit visual template 25 September 2026: sky-400/blue-500/cyan-500
    // + teks putih cuma ~2.5-3:1 (4 template gagal) -- digeser SATU
    // tingkat lebih pekat (tetap biru cerah, jauh dari navy "sapphire")
    // + kartu kaca gelap tipis supaya teks putih lolos WCAG AA.
    label: "Azure",
    page: "bg-gradient-to-br from-sky-600 via-blue-600 to-cyan-700",
    glow: "bg-gradient-to-br from-white/25 via-sky-200/10 to-transparent",
    avatarRing: "ring-4 ring-white/80 shadow-hero",
    name: "text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.3)]",
    bio: "text-white/95 drop-shadow-[0_1px_6px_rgba(0,0,0,0.3)]",
    card: "border border-white/20 bg-black/20 backdrop-blur-md hover:bg-black/30 hover:-translate-y-0.5",
    cardTitle: "text-white",
    chevron: "text-white/55",
    productCard: "border border-white/20 bg-black/20 backdrop-blur-md",
    productTitle: "text-white",
    productPrice: "text-white/90",
    buyButton: "bg-white text-ink font-bold hover:brightness-95",
    footer: "text-white/40 hover:text-white",
    swatch: "#0284C7",
    previewBg: "linear-gradient(135deg, #0284c7 0%, #2563eb 50%, #0e7490 100%)",
    previewIsDark: true,
    pageStyle: { fontFamily: "var(--font-custom-space-grotesk)" },
  },
  blush: {
  ...
  bliss: {
    ...
    productTitle: "text-ink",
    productPrice: "text-[#7657ff]",
    buyButton: "bg-[#ff6448] text-ink font-bold border-2 border-[#111111] hover:brightness-105",
    footer: "text-ink/35 hover:text-ink",
    swatch: "#ff6448",
  ...
  villa: {
    ...
    name: "text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.45)]",
    bio: "text-white drop-shadow-[0_1px_6px_rgba(0,0,0,0.6)]",
    ...
    buyButton: "bg-[#fe5642] text-[#111111] font-bold border-2 border-[#111111] hover:brightness-105",
    footer: "text-white/60 hover:text-white",
    swatch: "#fe5642",
  ...
  arcade: {
    ...
    productTitle: "text-[#111111]",
    productPrice: "text-[#111111]",
    buyButton: "bg-[#f45a4a] text-[#111111] font-bold border-2 border-[#111111] hover:brightness-105",
    footer: "text-white/60 hover:text-white",
    swatch: "#f45a4a",
