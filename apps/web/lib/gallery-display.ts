...
import { CircleDot, GalleryHorizontal, GalleryHorizontalEnd, LayoutDashboard, LayoutGrid, LayoutTemplate, Layers } from "lucide-react";
...
// display lagi untuk image grid". "fan" menyusul 19 September 2026 dari
// screenshot referensi pengguna ("buat tipe layout yang seperti ini"):
// tiga foto LANSKAP dikipas ke kiri-kanan (bukan bertumpuk rapat seperti
// "stack"), judul besar + subjudul berikon "Galeri · N foto" di bawahnya,
// popup foto yang sama dengan "stack".
export const GALLERY_DISPLAYS = ["grid", "stack", "fan", "carousel", "collage", "masonry", "circles"] as const;
...
export const GALLERY_DISPLAY_OPTIONS: { value: GalleryDisplay; labelKey: string; hintKey: string; Icon: LucideIcon }[] = [
  ...
  { value: "fan", labelKey: "displayFan", hintKey: "displayFanHint", Icon: GalleryHorizontalEnd },
