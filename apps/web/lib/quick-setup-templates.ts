...
//
// DIBALIK 25 September 2026 (permintaan langsung pengguna setelah audit
// visual template: 55 dari 69 kartu unggulan tampil polos tanpa gambar
// dan terlihat "kosong"; pilihan yang diberikan: "add CC0 photos to the
// featured cards"): SEMUA kartu unggulan kini bergambar -- foto suasana
// CC0 per niche (public/quick-setup-showcase/niche/, sumber di
// CREDITS.md). Kekhawatiran "menyesatkan" di atas tetap dijaga lewat
// PILIHAN foto: suasana/benda umum (mesin cuci, kursi salon, stadion),
// BUKAN tempat/produk/tokoh sungguhan yang bisa dikira milik kreator --
// dan kreator tetap bisa menggantinya lewat "Kelola gambar".
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        imagePath: "/quick-setup-showcase/niche/influencer.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        imagePath: "/quick-setup-showcase/niche/personal-branding.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/public-figure.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.youtube,
        imagePath: "/quick-setup-showcase/niche/gamer.jpg",
      }),
  ...
  // villa (kategori Tourism).
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.youtube,
        imagePath: "/quick-setup-showcase/niche/islamic-creator.jpg",
      }),
  ...
  // lengkap di PageThemeName, page-themes.ts, kenapa tema ini dibuat).
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        imagePath: "/quick-setup-showcase/niche/ugc-creator.jpg",
      }),
      faqBlock([
  ...
  // ---------- Business & Professional ----------
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        imagePath: "/quick-setup-showcase/niche/business-profile.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        url: PLATFORM_URL.website,
        imagePath: "/quick-setup-showcase/niche/company.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        ctaText: "Lihat studi kasus",
        url: PLATFORM_URL.linkedin,
        imagePath: "/quick-setup-showcase/niche/freelancer.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.linkedin,
        imagePath: "/quick-setup-showcase/niche/consultant.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.website,
        imagePath: "/quick-setup-showcase/niche/agency.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.linkedin,
        imagePath: "/quick-setup-showcase/niche/professional-cv.jpg",
      }),
  ...
  // villa (kategori Tourism).
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/insurance-agent.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/coworking-space.jpg",
      }),
  ...
  // toko buku belum terwakili di kategori ini.
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        ctaText: "Lihat Produk",
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/baby-kids-store.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/artist.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.spotify,
        imagePath: "/quick-setup-showcase/niche/podcaster.jpg",
      }),
  ...
  // Tema) -- yang diubah cuma pilihan DEFAULT template quick-setup ini.
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.youtube,
        imagePath: "/quick-setup-showcase/niche/motivational-speaker.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/barbershop.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/salon.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/photographer.jpg",
      }),
  ...
  // semuanya jasa personal, bukan bisnis penyewaan tempat/venue.
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/sports-facility.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/nightlife-venue.jpg",
      }),
  ...
  // Tourism) soal filosofi penambahan batch ini.
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/real-estate-agent.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        ctaText: "Lihat portofolio lengkap",
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/wedding-organizer.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/laundry-service.jpg",
      }),
  ...
  // -- kategori baru, lihat catatan lengkap di QUICK_SETUP_CATEGORIES.
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/travel-agency.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/tour-guide.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        ctaText: "Lihat rute lengkap",
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/culinary-tour.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        ctaText: "Lihat rute lengkap",
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/city-tour.jpg",
      }),
  ...
  // ---------- Special Purpose ----------
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.linkedin,
        imagePath: "/quick-setup-showcase/niche/portfolio.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/event.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/community.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/donation.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        ctaText: "Lihat jadwal lengkap",
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/mosque-community.jpg",
      }),
  ...
  // waiting list pre-launch belum terwakili di kategori ini.
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/giveaway.jpg",
      }),
      faqBlock([
  ...
  // ---------- Sports & Athletics (benchmark Linktree "Sports") ----------
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/athlete-profile.jpg",
      }),
    ],
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/sports-tournament.jpg",
      }),
      faqBlock([
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        ctaText: "Lihat Detail",
        url: PLATFORM_URL.whatsapp,
        imagePath: "/quick-setup-showcase/niche/business-mentor.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        ctaText: "Lihat Paket",
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/template-preset-seller.jpg",
      }),
      faqBlock([
  ...
  // template sebelumnya yang semuanya soal dokumen/desain/software.
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        ctaText: "Dengerin Sekarang",
        url: PLATFORM_URL.youtube,
        imagePath: "/quick-setup-showcase/niche/beat-producer.jpg",
      }),
      faqBlock([
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/recipe-ebook.jpg",
      }),
      faqBlock([
  ...
  // seller belum terwakili di kategori ini.
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/stock-media-seller.jpg",
      }),
      faqBlock([
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        ctaText: "Lihat Detail",
        url: PLATFORM_URL.instagram,
        imagePath: "/quick-setup-showcase/niche/font-seller.jpg",
      }),
  ...
  // pemasaran per-spesialisasi.
  {
    ...
    blocks: [
      ...
      showcaseBlock({
        ...
        ctaText: "Lihat Hasil",
        url: PLATFORM_URL.linkedin,
        imagePath: "/quick-setup-showcase/niche/digital-marketing-agency.jpg",
      }),
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        imagePath: "/quick-setup-showcase/niche/seo-specialist.jpg",
      }),
      faqBlock([
  ...
  },
  {
    ...
    blocks: [
      showcaseBlock({
        ...
        ctaText: "Ikut Sekarang",
        url: PLATFORM_URL.website,
        imagePath: "/quick-setup-showcase/niche/brand-campaign.jpg",
      }),
      faqBlock([
